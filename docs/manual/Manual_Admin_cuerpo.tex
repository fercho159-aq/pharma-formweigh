...
fila --- \cd{¿Confirmar rechazo?} con \boton{Sí, rechazar} y \boton{Cancelar} ---
porque \rechazado{} es un estado final. Conviene mencionarlo en la capacitación de
Calidad y Supervisión: la confirmación protege del clic accidental, no de la decisión,
y una vez confirmada no hay deshacer.
\end{cajaNota}
