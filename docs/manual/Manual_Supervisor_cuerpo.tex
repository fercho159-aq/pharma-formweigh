...
{\footnotesize\color{gristexto}Lotes con estado y botones de aprobación/rechazo para los que están en cuarentena.}
\end{center}
...
{\footnotesize\color{gristexto}Pantalla de recepción: escanea el código del material y llena los datos del lote.}
\end{center}
...
{\footnotesize\color{gristexto}Formulario de nueva receta con campos generales e ingredientes.}
\end{center}
...
{\footnotesize\color{gristexto}Audit trail: registro inmutable de todas las acciones con filtros por acción y usuario.}
\end{center}
