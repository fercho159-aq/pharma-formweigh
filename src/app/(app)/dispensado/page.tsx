        ...
        <div className="space-y-8">
          ...
          {enProceso.length > 0 && (
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {enProceso.map((o) => <OrderCard key={o.id} orden={o} />)}
              </div>
            </section>
          )}
          ...
          {pendientes.length > 0 && (
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {pendientes.map((o) => <OrderCard key={o.id} orden={o} />)}
              </div>
            </section>
          )}
          ...
          {completadas.length > 0 && (
            <section>
              ...
              {showCompleted && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {completadas.map((o) => <OrderCard key={o.id} orden={o} />)}
                </div>
              )}
            </section>
          )}
